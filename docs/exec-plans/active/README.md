...
`phase40.md` remains in this directory only as an immutable preregistration
source. Its normalized hash is embedded in the committed Phase 40 and Phase 42
artifacts, so moving or editing it would invalidate those frozen results. Phase
40 is scientifically completed; its outcome is recorded in
`../completed/phase40_execution_outcome.md`. It is not a second active plan and
does not authorize more small-system points or Paper B.
