...
Point evaluation & $2\le N\le6$ & Shifted-Legendre evaluation determinant and inverse, and the direct Cayley point formula of Eq.~\eqref{eq:legendre-point-value}. \\
...
\texttt{1d2208d3e5cb14f5c8e6c875f7fddf51}\allowbreak
\texttt{c47ce9a3e61be6cedb8246d662b3a016}.
\item Point evaluation verifier:\\
\texttt{f2ed7656126cdb408a312b97f6ac9a8c}\allowbreak
\texttt{bf0f323896ef14919d3c67998456b4aa}.
...
\section{Discussion: a two-mechanism map for antisymmetrization}
...
\begin{tabularx}{\textwidth}{@{}P{20mm}Y Y@{}}
\toprule
 & P2: commutative & not P2: noncommutative \\
\midrule
P1 & Slater, generalized Slater, backflow, and FermiNet determinant channels:
the $N!$ Leibniz terms collapse to ordinary determinants. & One-form
\FEMPS{}: exterior signs accompany row-ordered virtual products, giving a
Cayley determinant. \\
not P1 & The signed Hamilton-path polynomial in Eq.~\eqref{eq:signed-path}:
open cell in the present bounded search. & General explicit
antisymmetrization; conditional hardness only for a precisely defined class
that exactly contains the hard bond-two one-form cores with polynomial
overhead. \\
\bottomrule
\end{tabularx}
