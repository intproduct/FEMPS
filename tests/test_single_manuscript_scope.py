...
def test_submission_source_hygiene_and_scientific_boundaries() -> None:
    ...
    for required in (
        ...
        "unnormalized shifted Legendre",
        "Theorem~\\ref{thm:pointwise} and Theorem~\\ref{thm:c1} are independent reductions",
        "do not preclude efficient approximate QMC/VMC",
        "Universal\napproximation does not imply exact containment",
        "This is an embedding statement, not a norm-hardness reduction",
